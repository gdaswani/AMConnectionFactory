...
public class IllegalConnectionStateException extends RetryableException {
	...
	public IllegalConnectionStateException(Throwable cause) {
		super("APIILLEGALSTATE", String.format(
				NLS.ERRORS.getString("connection.illegal.state"), cause), cause);
	}
