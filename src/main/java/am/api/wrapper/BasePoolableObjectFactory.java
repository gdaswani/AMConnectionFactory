...
public interface BasePoolableObjectFactory extends KeyedPooledObjectFactory<AMCredential, AMBaseConnection> {
	BasePoolableObjectFactory setConnectionPool(ConnectionPool connectionPool);
}
