...
public final class SetFieldLongValue implements Callable<Long> {
	...
	public SetFieldLongValue(AMConnectionDelegate delegate, AMHandle recHandle, String fieldName, long value) {
		super();
