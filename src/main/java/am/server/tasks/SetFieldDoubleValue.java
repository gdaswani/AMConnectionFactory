...
public final class SetFieldDoubleValue implements Callable<Long> {
	...
	public SetFieldDoubleValue(AMConnectionDelegate delegate, AMHandle recHandle, String fieldName, double value) {
		super();
