...
public final class DeleteLink implements Callable<Long> {
	...
	public DeleteLink(AMConnectionDelegate delegate, AMHandle srcRecHandle, String linkName, AMHandle srcDstHandle) {
		super();
