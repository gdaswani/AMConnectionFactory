...
public final class SetFieldStrValue implements Callable<Long> {
	...
	public SetFieldStrValue(AMConnectionDelegate delegate, AMHandle recHandle, String fieldName, String value) {
		super();
